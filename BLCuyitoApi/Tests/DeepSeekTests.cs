...
namespace Tests
{
    internal class DeepSeekTests
    {
        ...
        internal static void TemplateCompletionTest()
        {
            ...
            var service = new DSTemplateFillingService();

            // Executing request (WARNING: Call to DeepSeek API)

            HttpResponseMessage result = service.FillTemplates("deepseek-chat", accountingChart, "tab-separated values (TSV)", transactions); ;
            ...
            File.WriteAllText(path, filledTemplates);
